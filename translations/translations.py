...
_COMMON_TRANSLATIONS: Dict[Language, TranslationsDict] = {
    "ru": {
        ...
        "new": "Новая", "status_new": "Новая", "status_diagnostics": "Диагностика", "status_in_progress": "В работе",
        "status_ready": "Готова", "status_closed": "Закрыта", "status_cancelled": "Отменена",
        "diagnostics": "Диагностика", "in_progress": "В работе",
    ...
    "en": {
        ...
        "new": "New", "status_new": "New", "status_diagnostics": "Diagnostics", "status_in_progress": "In progress",
        "status_ready": "Ready", "status_closed": "Closed", "status_cancelled": "Cancelled",
        "diagnostics": "Diagnostics", "in_progress": "In progress",
